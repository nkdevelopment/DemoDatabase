...
public class RecyclerViewTemplate extends AppCompatActivity {
    ...
    private void setAdapter() {
        ...
        mAdapter = new RecyclerViewAdapter(RecyclerViewTemplate.this, modelList);
        ...
        mAdapter.SetOnItemClickListener(new RecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, AbstractModel model) {
                ...
                Toast.makeText(RecyclerViewTemplate.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
